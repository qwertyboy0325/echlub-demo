...
import { BPM, sceneForBar, TOTAL_BARS } from "./musicData";
import type { NoteEvent, SceneDefinition } from "./types";
...
export class AudioEngine {
  ...
  get state(): Tone.BasicPlaybackState {
    return Tone.getTransport().state;
  }

  private applySceneFx(scene: SceneDefinition, time: number): void {
