...
export const PHASE5_WALKTHROUGH: WalkthroughStep[] = [
  ...
  {
    beat: 3,
    label: "At Kai · Keys Desk · LH edit",
    commands: [
      { type: "ENABLE_FOLLOW" },
  ...
  {
    beat: 4,
    label: "Kai · velocity lift",
    commands: [{ type: "SET_NOTE_VELOCITY", draftId: "kai-lh-sparse-4", noteId: "kai-lh-sparse-4-0", velocity: 0.68 }],
    delayMs: 350,
  },
  {
    beat: 5,
    label: "Kai · preview LH",
    commands: [{ type: "PREVIEW_WORKSPACE", draftId: "kai-lh-sparse-4" }],
    delayMs: 400,
  },
  {
    beat: 6,
  ...
  {
    beat: 9,
    label: "At Ryo · Rhythm Desk · bass preview",
    commands: [
